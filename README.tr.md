...
ayrı bir upstream model üretir. Önceden kurulmuş bir yerel model sunucusunu
upstream olarak kullanabilirsiniz:
...
API kullanımından bağımsızdır ve yerel sayaç tarafından sınırlanmaz. Proje bunu kendiliğinden
